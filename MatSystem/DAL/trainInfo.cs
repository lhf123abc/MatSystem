...
namespace Maticsoft.DAL
{
	...
	public partial class trainInfo
	{
		...
		public int Add(Maticsoft.Model.trainInfo model)
		{
			...
			strSql.Append("seriaNum,train,route)");
		...
		public bool Update(Maticsoft.Model.trainInfo model)
		{
			...
			parameters[3].Value = model.seriaNum;
		...
		public Maticsoft.Model.trainInfo GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,seriaNum,train,route from trainInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,seriaNum,train,route ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,seriaNum,train,route ");
			strSql.Append(" FROM trainInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
